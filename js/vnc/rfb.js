...
export default class RFB extends EventTargetMixin {
    constructor(target, url, options) {
        ...
        this._sock.on('message', (type) => {
            Log.Info(`handleMessage type ${type}`);
        
            switch (type) {
                case SMessageType.SVNCData:
                    // console.log("recive SVNCData!");
                    this._handleMessage();
                    break;
        ...
        switch (msgType) {
            case 0:  // FramebufferUpdate
                ...
                if (ret && !this._enabledContinuousUpdates) {
                    setTimeout(RFB.messages.fbUpdateRequest(this._sock, true, 0, 0,
                                                 this._fbWidth, this._fbHeight), 100);
                }
                return ret;
